...
export const routeTable: RouteEntry[] = [
  ...
  { key: 'BLOG_POST', path: ROUTES.BLOG_POST, page: 'BlogPostPage', importPath: './pages/BlogPostPage', label: 'Blog Post', admin: false, nav: true },
  ...
  { key: 'RESERVATIONS', path: ROUTES.RESERVATIONS, page: 'ReservationsPage', importPath: './pages/ReservationsPage', label: 'Reservations', admin: false, nav: true },
